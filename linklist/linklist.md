...
1. Create two linkedlist for odd and even linkedlist.
2. To do whileloop, if odd element, connect to odd linkedlist. if even element,
   connect to even linkedlist.
3. Finally, even linkedlist is connected by odd linkedlist.
